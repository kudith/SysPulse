              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link 
                      href="#pengenalan" 
                      className="block px-3 py-1.5 text-[#a8aebb] hover:text-[#d8dee9] hover:bg-[#1e1e1e] rounded-md transition-colors"
                    >
                      Pengenalan
                    </Link>
                  </li>
          ...
          <div className="md:col-span-3 space-y-12">
            ...
            <section id="panduan-cepat" className="scroll-mt-24">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <h3>Menggunakan Dashboard</h3>
                <p>
                  Dashboard SysPulse dirancang untuk memberikan gambaran lengkap tentang kesehatan server Anda:
                </p>
                <div className="bg-[#1e1e1e] p-5 rounded-lg border border-zinc-800/50 mt-4 mb-6">
                  <ol className="list-decimal pl-5 text-[#a8aebb] space-y-4">
                    <li>
                    ...
                    <li>
                      ...
                      <p className="mt-1">Drag-and-drop widget untuk menyusun ulang, ubah ukuran dengan menarik sudut widget</p>
                    </li>
                    <li>
                      <div className="flex items-center space-x-2">
                        <span className="text-[#d8dee9] font-medium">Menambahkan Widget</span>
                      </div>
                      <p className="mt-1">Klik tombol "+" di sudut kanan atas untuk menambahkan widget baru ke dashboard Anda</p>
                    </li>
                    <li>
                      <div className="flex items-center space-x-2">
                        <span className="text-[#d8dee9] font-medium">Detail Mendalam</span>
                      </div>
                      <p className="mt-1">Klik pada widget untuk melihat detail dan grafik historis dari metrik tersebut</p>
                    </li>
                  </ol>
                </div>
                ...
                <div className="bg-[#1e1e1e] p-5 rounded-lg border border-zinc-800/50 mt-4 mb-6">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      <h4 className="text-[#d8dee9] font-semibold mb-3">Perintah Berguna</h4>
            ...
            <section id="terminal" className="scroll-mt-24">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <p>
                  Untuk mengakses terminal setelah terhubung ke server Anda:
                </p>
                <ol>
                  <li>Buka halaman Server dari navigasi utama</li>
                  <li>Pilih server yang ingin Anda akses</li>
                ...
                <h3>Perintah Berguna</h3>
                <p>Perintah khusus SysPulse yang tersedia di terminal:</p>
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <ol>
                  ...
                  <li>Masukkan detail koneksi dalam formulir:
                    <ul>
                      <li>Host: alamat IP atau hostname server</li>
                      <li>Port: biasanya 22 (default)</li>
                      <li>Username: nama pengguna SSH Anda</li>
                      <li>Private Key: tempel kunci pribadi Anda atau unggah file kunci</li>
                      <li>Jika menggunakan passphrase, aktifkan opsi dan masukkan passphrase</li>
                    </ul>
                  </li>
                ...
                <h3>Pemecahan Masalah Koneksi</h3>
                <p>
            ...
            <section id="ngrok" className="scroll-mt-24">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <h3>Mengapa Menggunakan Ngrok dengan SysPulse?</h3>
                <p>
                  Saat menjalankan server di lingkungan lokal atau jaringan privat, Anda mungkin tidak memiliki IP publik tetap.
                  Ngrok membantu mengatasi masalah ini dengan membuat tunnel aman sehingga SysPulse dapat terhubung ke server Anda.
                </p>
                
                <h3>Langkah-langkah Pengaturan Ngrok</h3>
                <ol>
                  <li>
...
Connections                   ttl     opn     rt1     rt5     p50     p90                     
                ...
                <h3>Menggunakan Ngrok dengan SysPulse</h3>
                <p>
                  Setelah tunnel Ngrok berjalan, ikuti langkah-langkah berikut untuk terhubung menggunakan SysPulse:
                </p>
                <ol>
            ...
            <section id="vm-cloud" className="scroll-mt-24">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <div className="bg-[#1e1e1e] p-5 rounded-lg border border-zinc-800/50 mt-2 mb-6">
                  ...
                  <ol className="list-decimal pl-5 text-[#a8aebb] space-y-2">
                    <li>Di AWS Console, pastikan instance EC2 Anda berjalan</li>
            ...
            <section id="pemantauan" className="scroll-mt-24">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <h3 className="mt-8">Dasbor Kustom</h3>
                <p>
                  SysPulse memungkinkan Anda membuat dasbor kustom untuk memantau metrik yang paling penting bagi Anda:
                </p>
                <ol>
                  ...
                  <li>Untuk setiap widget, pilih:
                    <ul>
                      <li>Jenis metrik (CPU, memori, disk, dsb.)</li>
                      <li>Server yang ingin dipantau</li>
                      <li>Interval waktu (waktu nyata, 1 jam terakhir, 1 hari, dsb.)</li>
                      <li>Jenis visualisasi (grafik, gauge, tabel, dsb.)</li>
                    </ul>
                  </li>
                ...
                <h3 className="mt-8">Melihat Histori dan Tren</h3>
                <p>
                  SysPulse menyimpan data historis untuk semua metrik yang dikumpulkan, memungkinkan Anda:
                </p>
                <ul>
                ...
                <h3 className="mt-8">Pengaturan Agen Pemantauan</h3>
                <p>
                  Agen pemantauan SysPulse berjalan di server Anda untuk mengumpulkan metrik kinerja:
                </p>
                <ul>
                  <li>
            ...
            <section id="pemberitahuan" className="scroll-mt-24">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-[#a8aebb] prose-li:text-[#a8aebb] prose-headings:text-[#d8dee9] prose-a:text-[#6be5fd] prose-a:no-underline hover:prose-a:text-[#8ff4ff]">
                ...
                <h3>Jenis Peringatan</h3>
                <p>
                  SysPulse mendukung berbagai jenis peringatan berdasarkan metrik yang dikumpulkan:
                </p>
                ...
                <h3 className="mt-6">Metode Notifikasi</h3>
                <p>
                  SysPulse dapat mengirimkan notifikasi melalui berbagai saluran:
                </p>
                ...
                <h3 className="mt-8">Mengonfigurasi Peringatan</h3>
                <p>
                  Untuk mengonfigurasi peringatan baru:
                </p>
                ...
                <ol>
                  ...
                  <li>Konfigurasi kriteria peringatan:
                    <ul>
                      <li>Pilih server yang akan dipantau</li>
                      <li>Pilih metrik untuk memicu peringatan</li>
                      <li>Tetapkan kondisi dan ambang batas</li>
                      <li>Tentukan durasi (berapa lama kondisi harus bertahan)</li>
                    </ul>
                  </li>
                ...
                <h3 className="mt-8">Riwayat Peringatan</h3>
                <p>
                  SysPulse menyimpan riwayat lengkap semua peringatan yang dipicu, memungkinkan Anda:
                </p>
                <ul>
        ...
        <div className="max-w-5xl mx-auto border-t border-[#3fdaa4]/10 pt-8">
          <div className="flex flex-col items-center">
            ...
            <div className="flex space-x-4">
              <button className="px-6 py-2 bg-[#161616] border border-[#3fdaa4]/20 rounded-md text-[#d8dee9] hover:bg-[#1e1e1e] hover:border-[#3fdaa4]/40 transition-colors">
                Ya, sangat membantu
              </button>
              <button className="px-6 py-2 bg-[#161616] border border-[#3fdaa4]/20 rounded-md text-[#d8dee9] hover:bg-[#1e1e1e] hover:border-[#3fdaa4]/40 transition-colors">
